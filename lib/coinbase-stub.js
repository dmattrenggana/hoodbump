 ...
 *
 * This stub:
 *   - Exports createCoinbaseWalletSDK() → returns a minimal SDK object
 *   - Exports CoinbaseWalletProvider as a class
 *   - Avoids the actual SDK bundle (saves ~1MB)
 */
...
module.exports = { createCoinbaseWalletSDK, CoinbaseWalletProvider: StubCoinbaseWalletProvider }
module.exports.default = createCoinbaseWalletSDK